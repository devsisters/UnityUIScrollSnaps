...
public class DirectionalScrollSnapEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (scrollSensativity.floatValue < 0)
            scrollSensativity.floatValue = 0;
